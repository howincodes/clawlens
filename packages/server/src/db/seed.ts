...
const DEFAULT_ROLES: Array<{ name: string; description: string; isSystem: boolean; permissionKeys: string[] }> = [
  ...
  {
    name: 'Team Lead',
    description: 'Lead a team — manage users, tasks, and view reports',
    isSystem: true,
    permissionKeys: [
  ...
  },
  {
    ...
    description: 'Coordinate project tasks and track progress',
    isSystem: true,
    permissionKeys: [
      'tasks.manage', 'tasks.create', 'tasks.assign', 'tasks.view',
      'projects.view', 'projects.members',
  ...
  {
    name: 'HR',
    description: 'Manage attendance, leave, and salary',
    isSystem: true,
    permissionKeys: [
